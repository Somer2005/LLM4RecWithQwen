...
def run_evaluation(model_name="qwen2.5-1.5b-instruct", sample_size=20, k=10):
    """运行完整评估（优化兼容性和错误处理）"""
    ...
    try:
        ...
        users = system['users']
        dssm_recaller = system['dssm_recaller']
...
if __name__ == "__main__":
    ...
    run_evaluation(model_name="qwen2.5-1.5b-instruct", sample_size=10, k=10)
